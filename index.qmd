...
\begin{align}
X = \begin{bmatrix}
\color{Red} 1 & \color{Red} y_{0,1} & \color{Red}\cdots & \color{Red}y_{0,4}, & \color{Red}y_{-1,1} &\color{Red}\cdots & \color{Red}y_{-1,4}, & \color{Red}y_{-2,1} &\color{Red}\cdots & \color{Red}y_{-2,4}, &\color{Red}\cdots & \color{Red}y_{-p,1} & \color{Red}\cdots & \color{Red}y_{-p,4}\\
1 & y_{1,1} &\cdots & y_{1,4} ,& y_{0,1} &\cdots & y_{0,4}, & y_{-1,1} &\cdots & y_{-1,4}, &\cdots & y_{-p+1,1} &\cdots & y_{-p+1,4}\\
\color{Cyan}1 & \color{Cyan} y_{2,1} & \color{Cyan}\cdots & \color{Cyan} y_{2,4}, &\color{Cyan} y_{1,1} &\color{Cyan}\cdots & \color{Cyan}y_{1,4}, &\color{Cyan} y_{0,1} &\color{Cyan}\cdots &\color{Cyan} y_{0,4}, &\color{Cyan}\cdots &\color{Cyan} y_{-p+2,1} &\color{Cyan}\cdots &\color{Cyan} y_{-p+2,4}\\
\vdots  &\vdots   & \vdots  & \vdots &\vdots   & \vdots  & \vdots   &\vdots   & \vdots  & \vdots   &\vdots   & \vdots  & \vdots  \\
1 & y_{T-1,1} &\cdots & y_{T-1,4}, & y_{T-2,1} &\cdots & y_{T-2, 4}, & y_{T-3,1} &\cdots & y_{T-3,4}, &\cdots & y_{T-p,1} &\cdots & y_{T-p,4}\\
\end{bmatrix} \\
\end{align}
```
```{=tex}
...
\color{Red}a_{1, 1, 1} &\color{Cyan}a_{1, 2,1}  & a_{1, 3,1} & a_{1, 4,1}\\
\color{Red}\vdots  &\color{Cyan}\vdots   & \vdots  & \vdots \\
\color{Red}a_{1, 1, 4} &\color{Cyan}a_{1, 2,4}  & a_{1, 3,4} & a_{1, 4,4}\\
\color{Red}\vdots  &\color{Cyan}\vdots   & \vdots  & \vdots \\
\color{Red}\vdots  &\color{Cyan}\vdots   & \vdots  & \vdots \\
\color{Red}a_{p, 1,1} &\color{Cyan}a_{p, 2,1}  & a_{p, 3,1} & a_{p, 4,1}\\\displaystyle 
\color{Red}\vdots  &\color{Cyan}\vdots   & \vdots  & \vdots \\
\color{Red}a_{p, 1,4} &\color{Cyan}a_{p, 2,4}  & a_{p, 3,4} & a_{p,4,4}\\
\end{bmatrix}
